...
class MainActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<RadioGroup>(R.id.radioGroup).setOnCheckedChangeListener(RadioGroup.OnCheckedChangeListener { radioGroup, i ->
            when (i) {
        ...
        findViewById<RadioGroup>(R.id.radioGroup2).setOnCheckedChangeListener(RadioGroup.OnCheckedChangeListener { radioGroup, i ->
            when (i) {
        ...
        findViewById<Button>(R.id.btn_send).setOnClickListener(View.OnClickListener {

            val drink = findViewById<EditText>(R.id.ed_drink).text.toString()
            val i = Intent()
            val b = Bundle()
